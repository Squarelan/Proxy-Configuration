 ...
 * @author      @Squarelan
 * @thanks      @chavyleung、@𝒀𝒖𝒉𝒆𝒏𝒈、@deezertidal、@Toperlock
 * @use         可通过BoxJS修改通知的热搜平台与显示的热搜数量
 * @update      2025.11.09
******************************************

BoxJS订阅地址：https://raw.githubusercontent.com/Squarelan/Proxy-Configuration/main/JS/boxjs.json

[task_local]
30 6-23 * * * https://raw.githubusercontent.com/Squarelan/Proxy-Configuration/main/JS/hotoday.js, tag=今日热搜, img-url=https://raw.githubusercontent.com/Toperlock/Quantumult/main/icon/hot.png, enabled=true
...
let platforms = [
  ...
  { name: '抖音', tag: 'douyin' },
  { name: '百度', tag: 'baidu' },
  { name: '贴吧', tag: 'baidu-tieba' },
  { name: '哔哩哔哩', tag: 'bilibili' },
  { name: '澎湃', tag: 'thepaper' },
  { name: '36氪', tag: '36kr' },
  { name: '少数派', tag: 'sspai' },
...
if (New_platform) {
  const query_addr = `https://rebang.today/home?tab=${New_platform.tag}`;
  const url = {
    url: query_addr
  };
